...
impl<'a> NewImageEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(NewImageEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn image_uuid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(NewImageEvent::VT_IMAGE_UUID, None)}
  }
  #[inline]
  pub fn image_format(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(NewImageEvent::VT_IMAGE_FORMAT, None)}
  }
  #[inline]
  pub fn image(&self) -> Option<flatbuffers::Vector<'a, u8>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, u8>>>(NewImageEvent::VT_IMAGE, None)}
  }
}
...
impl<'a> ImageReceivedEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageReceivedEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn image_uuid(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageReceivedEvent::VT_IMAGE_UUID, None)}
  }
  #[inline]
  pub fn image_format(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageReceivedEvent::VT_IMAGE_FORMAT, None)}
  }
}
...
impl<'a> ImageLabelScore<'a> {
  ...
  pub fn image_uuid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageLabelScore::VT_IMAGE_UUID, None)}
  }
  #[inline]
  pub fn label(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageLabelScore::VT_LABEL, None)}
  }
  #[inline]
  pub fn probability(&self) -> f32 {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<f32>(ImageLabelScore::VT_PROBABILITY, Some(0.0)).unwrap()}
  }
}
...
impl<'a> ImageScoredEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageScoredEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn image_uuid(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageScoredEvent::VT_IMAGE_UUID, None)}
  }
  #[inline]
  pub fn image_format(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageScoredEvent::VT_IMAGE_FORMAT, None)}
  }
  #[inline]
  pub fn scores(&self) -> Option<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ImageLabelScore<'a>>>> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<flatbuffers::Vector<'a, flatbuffers::ForwardsUOffset<ImageLabelScore>>>>(ImageScoredEvent::VT_SCORES, None)}
  }
}
...
impl<'a> ImageStoredEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageStoredEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn image_uuid(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageStoredEvent::VT_IMAGE_UUID, None)}
  }
  #[inline]
  pub fn image_format(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageStoredEvent::VT_IMAGE_FORMAT, None)}
  }
  #[inline]
  pub fn destination(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageStoredEvent::VT_DESTINATION, None)}
  }
}
...
impl<'a> ImageDeletedEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageDeletedEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn image_uuid(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageDeletedEvent::VT_IMAGE_UUID, None)}
  }
  #[inline]
  pub fn image_format(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(ImageDeletedEvent::VT_IMAGE_FORMAT, None)}
  }
}
...
impl<'a> PluginStartedEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginStartedEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn plugin_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginStartedEvent::VT_PLUGIN_NAME, None)}
  }
  #[inline]
  pub fn plugin_uuid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginStartedEvent::VT_PLUGIN_UUID, None)}
  }
}
...
impl<'a> PluginTerminatingEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginTerminatingEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn plugin_name(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginTerminatingEvent::VT_PLUGIN_NAME, None)}
  }
  #[inline]
  pub fn plugin_uuid(&self) -> Option<&'a str> {
    // Safety:
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginTerminatingEvent::VT_PLUGIN_UUID, None)}
  }
}
...
impl<'a> PluginTerminateEvent<'a> {
  ...
  pub fn event_create_ts(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginTerminateEvent::VT_EVENT_CREATE_TS, None)}
  }
  #[inline]
  pub fn target_plugin_name(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginTerminateEvent::VT_TARGET_PLUGIN_NAME, None)}
  }
  #[inline]
  pub fn target_plugin_uuid(&self) -> Option<&'a str> {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<flatbuffers::ForwardsUOffset<&str>>(PluginTerminateEvent::VT_TARGET_PLUGIN_UUID, None)}
  }
}
...
impl<'a> Event<'a> {
  ...
  pub fn event_type(&self) -> EventType {
    ...
    // Created from valid Table for this object
    // which contains a valid value in this slot
    unsafe { self._tab.get::<EventType>(Event::VT_EVENT_TYPE, Some(EventType::NONE)).unwrap()}
  }
  #[inline]
  ...
  pub fn event_as_new_image_event(&self) -> Option<NewImageEvent<'a>> {
    if self.event_type() == EventType::NewImageEvent {
      self.event().map(|t| {
       ...
       unsafe { NewImageEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_image_received_event(&self) -> Option<ImageReceivedEvent<'a>> {
    if self.event_type() == EventType::ImageReceivedEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { ImageReceivedEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_image_scored_event(&self) -> Option<ImageScoredEvent<'a>> {
    if self.event_type() == EventType::ImageScoredEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { ImageScoredEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_image_stored_event(&self) -> Option<ImageStoredEvent<'a>> {
    if self.event_type() == EventType::ImageStoredEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { ImageStoredEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_image_deleted_event(&self) -> Option<ImageDeletedEvent<'a>> {
    if self.event_type() == EventType::ImageDeletedEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { ImageDeletedEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_plugin_started_event(&self) -> Option<PluginStartedEvent<'a>> {
    if self.event_type() == EventType::PluginStartedEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { PluginStartedEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_plugin_terminating_event(&self) -> Option<PluginTerminatingEvent<'a>> {
    if self.event_type() == EventType::PluginTerminatingEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { PluginTerminatingEvent::init_from_table(t) }
     })
    } else {
      None
    }
  ...
  pub fn event_as_plugin_terminate_event(&self) -> Option<PluginTerminateEvent<'a>> {
    if self.event_type() == EventType::PluginTerminateEvent {
      self.event().map(|t| {
       ...
       // Created from a valid Table for this object
       // Which contains a valid union in this slot
       unsafe { PluginTerminateEvent::init_from_table(t) }
     })
    } else {
      None
    }
