...
import torch
import numpy as np
from run_detector import CONF_DIGITS, COORD_DIGITS
import ct_utils
try:
...
# THESE WERE ADD TO WORK WITH TRITON
...
class PTDetector:
    ...
    def __init__(self, model_path: str, force_cpu: bool = False):
        ...
        # OMITTING IN ORDER FOR TRITON EXAMPLE TO WORK
